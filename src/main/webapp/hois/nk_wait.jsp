            ...
            <td style="text-align: center">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#" @click="addResult('开具开药单',nk_wait.pno)">开具开药单</a></li>
                        <li><a href="#" @click="addResult('开具皮试单',nk_wait.pno)">开具皮试单</a></li>
                        <li><a href="#" @click="addResult('开具注射单',nk_wait.pno)">开具注射单</a></li>
                        <li><a href="#" @click="addResult('开具输液单',nk_wait.pno)">开具输液单</a></li>
                    </ul>
                </div>
...
<script src="../js/vue.js"></script>
     ...
     <script>
            ...
            var nk_waitVue = new Vue({
                ...
                data : {
                    nk_wait_List : [],
                    nk_wait : {pno:"", name:"", height:"", weight:"", dno:"", jzno:""},//产科信息记录
