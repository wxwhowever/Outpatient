            ...
            <td style="text-align: center">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#" @click="addResult('开具开药单',wk_wait.pno)">开具开药单</a></li>
                        <li><a href="#" @click="addResult('开具皮试单',wk_wait.pno)">开具皮试单</a></li>
                        <li><a href="#" @click="addResult('开具注射单',wk_wait.pno)">开具注射单</a></li>
                        <li><a href="#" @click="addResult('开具输液单',wk_wait.pno)">开具输液单</a></li>
                    </ul>
                </div>
