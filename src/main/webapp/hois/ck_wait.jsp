...
<div id="ck_waitList">
    ...
    <table class="tablelist table">
        ...
        <tr v-for="ck_wait in ck_wait_List">
            <td>{{ck_wait.wno}}</td>
            <td>{{ck_wait.pno}}</td>
            <td>{{ck_wait.name}}</td>
            <td>{{ck_wait.sex}}</td>
...
//                    显示模态框
            ...
            $(function(){
                ...
                $(".page").click(function(){
                    ...
                    var maxPage = ck_waitVue._data.maxPage;
                    if(selectPage == "首页"){
                        pageIndex = 1;
                    ...
                    $.ajax({
                        ...
                        type : "post",
                        success : function(data){
                            ck_waitVue._data.ck_wait_List = data.listData;
                            ck_waitVue._data.maxPage = data.maxPage;
                            ck_waitVue._data.currnetIndex = pageIndex;//设置当前页码为选中的页码
                        }
                    })
                })
