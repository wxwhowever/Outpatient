                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group form-inline">
                                ...
                                <input type="text" class="form-control" id="name" v-model="yk_wait.name">
                                <div style="float: right;">
                                    <label class="control-label">病人编号:</label>
                                    <input type="text" class="form-control" id="pno" v-model="yk_wait.age">
                                </div>
                            </div>
                            <div class="form-group form-inline">
                                <label class="control-label">身高:</label>
                                <input type="text" class="form-control" id="height" v-model="yk_wait.height">
                                <div style="float: right;">
                                <label class="control-label">体重:</label>
                                <input type="text" class="form-control" id="weight" v-model="yk_wait.weight">
                                </div>
                            </div>
                            <div class="form-group form-inline">
                                <label  class="control-label">记录人:</label>
                                <input type="text" class="form-control" id="dno" v-model="yk_wait.dno">
                                <div style="float: right;">
                                <label class="control-label">就诊卡号:</label>
                                <input type="text" class="form-control" id="jzno" v-model="yk_wait.jzno">
                                </div>
                            </div>
                        </form>
                    </div>
...
//                  增加、修改
                    save :function(){
                        ...
                        $.ajax({
                            url : _this.url,
                            data :{yk_wait : JSON.stringify(_this.yk_wait)},
                            success : function(data){
                    ...
                    insertYk_wait : function(){
                        this.modalTitle = "记录病人信息";//设置 modal 标题
                        this.url = "/insertYk_wait.action";//设置请求路径
                        this.yk_wait = {};//初始化银医卡
